    ...
    <div class="d-flex flex-row justify-content-between">
        <div class="container d-flex">
            <div class="welcome d-flex">
                <div class="name">
                    <h1 class="text-hblack p-0 m-0"><strong class="p-0">Update User,</strong></h1>
    ...
    <div class="section section-divider bills-of-license-purchased reveal mt-0">
        <div class="d-flex flex-column">
            <div class="section d-flex flex-column align-items-center mb-0">
                ...
                <h2 class="text-hblack font-weight-bold text-capitalize mt-3 sub-heading">Update User Details</h2>
            </div>
            <div class="d-flex flex-column justify-content-around mb-3 mt-3 ml-5 section-divider my-card my-card-border">
                <form action="{{ route('users.update', $user) }}" method="POST" id="update-user-form" enctype="multipart/form-data" class="border border-light shadow-lg p-4">
                    @csrf
                    @method('PUT')

                        <div class="d-flex flex-row justify-content-around section-divider">
                            <div class="form-group col-md-5">
                                <label for="company_id">Company ID<i class="ml-2 fa fa-user-circle"></i></label>
                                <input
                                type="text"
                                id="company_id"
                                name="company_id"
                                value="{{$user->company_id}}"
                                class="form-control @error('company_id') is-invalid @enderror" disabled>
                                @error('company_id')
